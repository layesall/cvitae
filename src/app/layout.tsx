...
const metadataByLocale = {
  fr: {
    ...
    description:
      "Je conçois et développe des produits web modernes : SaaS, boutiques Shopify et applications sur mesure. Développeur freelance disponible en remote / Bruxelles.",
    keywords: [
    ...
    twitter: {
      title: "Layesall — Produits web, SaaS & Shopify",
      description:
        "Développement de SaaS, Shopify et applications web modernes. Freelance disponible.",
    },
  },
  en: {
    title: "Layesall — Web Products, SaaS & Shopify | Freelance Developer",
    description:
      "I design and build modern web products: SaaS, Shopify stores and custom applications. Freelance developer available remote / Brussels.",
    keywords: [
      "freelance developer",
      "SaaS development",
      "Shopify development",
    ...
    openGraph: {
      ...
      description:
        "Modern SaaS, Shopify and web applications designed to be fast, simple and scalable.",
      locale: "en_US",
    },
    twitter: {
      title: "Layesall — Web Products, SaaS & Shopify",
      description:
        "SaaS, Shopify and modern web application development. Freelance available.",
    },
  },
};
